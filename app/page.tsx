...
const footerTech: { label: string; path?: string; viewBox?: string; node?: ReactNode }[] = [
  {
    label: "Bitcoin",
  ...
  },
  {
    ...
    node: (
      <>
        ...
        <path
          d="M15.5 7.5a6.5 6.5 0 0 0-5.2-1.3A6.5 6.5 0 0 0 5.5 12a6.5 6.5 0 0 0 4.8 6.3 6.5 6.5 0 0 0 5.2-1.3"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
          strokeLinecap="round"
          ...
          >
            {footerTech.map((t) => (
              <li key={t.label} title={t.label}>
                ...
                >
                  {t.node ?? <path fill="currentColor" d={t.path} />}
                </svg>
              </li>
            ))}
          </ul>
